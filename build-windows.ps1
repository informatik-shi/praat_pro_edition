...
try {
    ...
    if ($Test) {
        & $bash --login -c 'bash scripts/test-folding.sh && bash scripts/test-lua.sh && bash scripts/test-trajectories.sh && bash scripts/test-debugger.sh && bash scripts/test-windows.sh'
